      ...
      <n-card :bordered="false">
        ...
        >
          <n-tab-pane name="signin" tab="登录">
            ...
            >
              <n-form-item-row label="学号" path="username">
                <n-input
                    v-model:value="loginForm.username"
                    placeholder="请输入学号"
                    @keyup.enter.prevent="handleLogin"
          ...
          <n-tab-pane name="signup" tab="注册">
            ...
            >
              ...
              <n-form-item-row label="学号" path="student_id">
                <n-input
                    v-model:value="registerForm.student_id"
                    placeholder="学号注册后无法修改"
                />
              </n-form-item-row>
              <n-form-item-row label="统一验证密码" path="oauth">
                <n-input
                    type="password"
                    show-password-on="mousedown"
                    placeholder="请输入统一验证密码"
                    v-model:value="registerForm.oauth"
